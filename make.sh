...
cat ./chapters/abstract.md ./chapters/abstract2.md ./chapters/c*\.md ref.md > main.md && pandoc -V documentclass=report -V fontsize=12pt -V mainfont="Times New Roman" -H header.sty -s --bibliography=./Thesis_ZJNU.bib --csl=./Chinese-Full.csl main.md -o output.pdf --latex-engine=xelatex
